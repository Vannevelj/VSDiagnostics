...
namespace VSDiagnostics.Diagnostics.Exceptions.RethrowExceptionWithoutLosingStacktrace
{
    ...
    public class RethrowExceptionWithoutLosingStacktraceCodeFix : CodeFixProvider
    {
        ...
        public override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(CodeAction.Create(VSDiagnosticsResources.RethrowExceptionWithoutLosingStacktraceCodeFixTitle, x => RemoveRethrowAsync(context.Document, root, throwStatement), nameof(RethrowExceptionWithoutLosingStacktraceAnalyzer)), diagnostic);
        }
