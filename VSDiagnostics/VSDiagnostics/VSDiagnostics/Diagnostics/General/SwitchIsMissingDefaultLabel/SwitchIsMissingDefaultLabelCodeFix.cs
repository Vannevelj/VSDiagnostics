...
namespace VSDiagnostics.Diagnostics.General.SwitchIsMissingDefaultLabel
{
    ...
    internal class SwitchIsMissingDefaultLabelCodeFix : CodeFixProvider
    {
        ...
        private async Task<Solution> AddDefaultCaseAsync(Document document, CompilationUnitSyntax root, SyntaxNode statement)
        {
            ...
            var newNode = switchBlock.AddSections(defaultCase)
