...
namespace ConsoleApplication1
{
    enum MyEnum
    {
        ...
        [TestMethod]
        public void NamingConventions_WithConflicatingLocals()
        {
            var original = @"
using System;
using System.Text;
...
namespace ConsoleApplication1
{
    class MyClass
    {
        void Method()
        {
            ...
            VerifyDiagnostic(original, string.Format(NamingConventionsAnalyzer.ConflictingMemberRule.MessageFormat.ToString(), "local", "I", "local", "i"));
        }

        [TestMethod]
        public void NamingConventions_WithConflicatingLocalAndField()
        {
            var original = @"
using System;
using System.Text;
...
namespace ConsoleApplication1
{
    class MyClass
    {
        ...
        void Method()
        {
            ...
            VerifyDiagnostic(original, string.Format(NamingConventionsAnalyzer.ConflictingMemberRule.MessageFormat.ToString(), "local", "I", "field", "i"));
        }

        [TestMethod]
        public void NamingConventions_WithConflicatingClassAndClass()
        {
            var original = @"
using System;
using System.Text;
...
namespace ConsoleApplication1
{
    ...
    class MyClass
    {
            ...
            VerifyDiagnostic(original, string.Format(NamingConventionsAnalyzer.ConflictingMemberRule.MessageFormat.ToString(), "class", "myClass", "class", "MyClass"));
        }

        [TestMethod]
        public void NamingConventions_WithConflicatingClassAndStruct()
        {
            var original = @"
using System;
using System.Text;
...
namespace ConsoleApplication1
{
    ...
    struct MyType
    {
            ...
            VerifyDiagnostic(original, string.Format(NamingConventionsAnalyzer.ConflictingMemberRule.MessageFormat.ToString(), "class", "myType", "struct", "MyType"));
        }

        [TestMethod]
        public void NamingConventions_WithConflicatingClassAndMethod()
        {
            var original = @"
using System;
using System.Text;
...
namespace ConsoleApplication1
{
    class myMember
    {
        void MyMember()
        {
            ...
            VerifyDiagnostic(original, string.Format(NamingConventionsAnalyzer.ConflictingMemberRule.MessageFormat.ToString(), "class", "myMember", "method", "MyMember"));
        }

        [TestMethod]
        public void NamingConventions_WithConflicatingInnerClassAndMethod()
        {
            var original = @"
using System;
using System.Text;
...
namespace ConsoleApplication1
{
    class MyClass
    {
        ...
        [TestMethod]
        public void NamingConventions_WithConflicatingBaseClassMethod()
        {
            var original = @"
using System;
using System.Text;
...
namespace ConsoleApplication1
{
    ...
    class MyBaseClass
    {
        void MyMethod()
        {
            ...
            VerifyDiagnostic(original, string.Format(NamingConventionsAnalyzer.ConflictingMemberRule.MessageFormat.ToString(), "method", "myMethod", "method", "MyMethod"));
        }
    }
}